	...
	function form( $instance ) {
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block1title' ); ?>" name="<?php echo $this->get_field_name( 'block1title' ); ?>" value="<?php echo htmlentities($instance['block1title']); ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block2title' ); ?>" name="<?php echo $this->get_field_name( 'block2title' ); ?>" value="<?php echo htmlentities($instance['block2title']); ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block3title' ); ?>" name="<?php echo $this->get_field_name( 'block3title' ); ?>" value="<?php echo htmlentities($instance['block3title']); ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block4title' ); ?>" name="<?php echo $this->get_field_name( 'block4title' ); ?>" value="<?php echo htmlentities($instance['block4title']); ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block5title' ); ?>" name="<?php echo $this->get_field_name( 'block5title' ); ?>" value="<?php echo htmlentities($instance['block5title']); ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block6title' ); ?>" name="<?php echo $this->get_field_name( 'block6title' ); ?>" value="<?php echo htmlentities($instance['block6title']); ?>" type="text" />
                </p>
