...
class optimizer_front_About extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id( 'subtitle' ); ?>" name="<?php echo $this->get_field_name( 'subtitle' ); ?>" value="<?php echo htmlentities($instance['subtitle']); ?>" type="text" />
		</p>
